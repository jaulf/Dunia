...
import {
  ...
  setPriceFilter,
  setCategoryFilter,
} from "@/components/redux/products/filterProductsSlice";

export default function Discover() {
  const dispatch = useDispatch()
  const { ageFilter, creatorFilter, dateFilter, priceFilter, categoryFilter } = useSelector((state) => state.filters);
          ...
          <div className="px-10 pt-24 pb-[100px] flex flex-col">
            ...
            <div class="flex pt-[51px] pb-[40px] justify-between items-center">
              <div class="flex catb font-medium text-xl text-black items-center gap-[10px]">
                ...
                <span onClick={dispatch(setCategoryFilter('climate-change'))} class="px-[21px]">Climate change</span>
                <span onClick={dispatch(setCategoryFilter('sustainability'))}  class="px-[16px]">sustainability</span>
                <span onClick={dispatch(setCategoryFilter('biodiversity'))}  class="px-[19.5px]">biodiversity</span>
              </div>
            ...
            <div className="inline-blockgap-10 items-end">
              <div class="gap-4 flex items-end">
                <div class="filter">
                  <h6>Release date</h6>
                  <select onChange={e => dispatch(setDateFilter(e.target.value))} id="release-date" name="release-date" className="">
                ...
                <div class="filter">
                  <h6>Price</h6>
                  <select onChange={e => dispatch(setPriceFilter(e.target.value))} id="price" name="price">
                ...
                <div class="filter">
                  <h6>Age</h6>
                  <select onChange={e => dispatch(setAgeFilter(e.target.value))} id="age" name="age">
                    <option class="3-to-8">3 - 8 years old</option>
                    <option class="8-to-12">8 - 12 years old</option>
                    <option class="12-to-18">12 - 18 years old</option>
                  </select>
                </div>
