    ...
    >
      ...
      <header className="header-grdi">
        ...
        <div id="text-sidebar" className="flex w-full flex-col items-center">
          ...
          <div className="px-5 lg:px-[140px] pt-7 lg:pt-8 w-full flex flex-col justify-center items-center">
            <h2 className="millik text-[64px] leading-[62px] tracking-[-0.64px]">
              dunia
            </h2>

            <div className="flex w-full flex-col justify-center items-center gap-10 pt-16 lg:pt-[101px]">
